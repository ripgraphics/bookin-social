...
async function applyMigration() {
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, '..', 'supabase', 'migrations', '0021_add_app_rls_policies.sql');
    ...
    console.log(`\n✅ Total: ${result.rows.reduce((sum, row) => sum + parseInt(row.policy_count), 0)} policies created`);
